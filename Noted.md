...
I like the use of the old-fashioned bicycle being both the dangerous thing and to other being the cool thing. One object with the same use can be interpreted in many ways. (15-16)

Because of different interpretations of technology, in this case meaning written communication, certain parties may not use the same written technology in the same way. The anti-abortion brochure effectiveness be changed by how the 'technology' is used. To one party, the brochure is counterproductive; to the other party it is a helpful tool. The clinic cannot change the brochure's content, but they can change how it is used and presented. As seen in the conclusion on page 20, by providing the ability to return the brochure, and putting it at the bottom of a stack of papers, women seem less interested in the brochure than the brochures creator probably intended. This could happen with many writing technologies I imagine. Similar to how in the government case study.


##Your Actual Answer

"On the Relationship Between Old and New Technologies" takes a look at three separate workplaces studies to see how these workplaces use various communicative technologies. The work environments were vaired. A team of city engineers used many forms of written technology (CAD software to passed memos). A small-town city managers office is lacking most digital technology for communication, such as e-mail, but this is perfered by some to the point there is resistance to setting up an e-mail system. Lastly, an abortion clinic handles patient information on blue paper passed throughout the clinc, and is required by law to provide a brochure that need to be given to the patient before any proceedures. The study of the clinic revealed there is subtle political motivations behind the placements of the brochures that affect the patients use of the document and that the blue paper patient information is held on is powerful enough to bring work to halt if it goes missing.

The author uses the case studies, as well as borrowing from the analysis of other researcher's views of technical evolution, to demonstrate that technology does not simply advance in a linear pattern over time to the best solution. Technology does not always have to be the most advanced to be effective, and new technology may be rejected to those who do not see the use of it for themselves. Furthermore, there are many technologies at use in a workplace that aid communication, including e-mails, schematics, charts and even phone calls. Not one in inherently better than the other and not one is inheriently the best for any work environment. The article concludes by calling for more studies to focus on the history of new and old technologies and how they are intertwined to fully understand how technology affects communication.

That was a bit hard to summerize; it was a very thick article. 

My favorite part of this article was the mentioning that the exact same technology can be  viewed differently by different people. Specifically, on pages 15 and 16, the discussion on how a penny-farthing bicycle could be viewed as dangerous (non-working) or cool (working). That idea heavily relates to the case study examples. The city manager who wanted e-mail wasn't able to implement that system because members of the town saw the technology as non-working. The same thing happened at the abortion clinic with the brochure: the clinic did not see it as working technology, and subsequently didn't treat it as such. Its users in return did not treat it as working, and mostly ignored it. I think this is an important perspective when choosing a technology that I didn't fully consider before. The concept is not difficult, but it's easy to get wrapped up in ones own opinion of a technology that they don't consider how others feel about it and how that opinion affects the use.

## Connections

There is a clear connection between the grid article and the table history article. I would say the grid article is a future from the history discussed in the table article. That being said, the author of the table article would probably be dishearted by that, because a grid is, well, a grid. Everything is going to stay square shaped; there hasn't been advances to totally revolutionize how a grid can appear. I don't think the benefits of the grid system are benefits that the table article author was looking for. That being said, the table article gives a clear history of why everything is a grid and why we're stuck in that mentality. 

There is a light connection between the handwriting article and the old and new technology article. The handwriting article is discussing if aspects of learning and connection with text are lost when things are typed instead of handwritten. This would be a discussion of old and new technology. The handwriting article evidence demonstrates that sometimes handwriting is preferable, and that preference can simply be a matter of opinion. This related to the old a new articles ideas of working and not-working technology. If one learns a new alphabet via typing, but ends up forgetting it sooner than if they were handwriting, the technology of typing isn't working for them in that situation.
